...
<body>
    <div id="app">
        ...
        <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow py-3">
            <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="{{ url('/') }}">Lara
                School</a>
                        ...
                        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3  ">
                            <ul class="nav flex-column">
                                @if (Route::has('dashboard.index'))
                                    <li class="nav-item">
                                        <a
                                            class="nav-link d-flex align-items-center gap-2"href="{{ route('dashboard.index') }}">
                                ...
                                @if (Route::has('courses.index'))
                                    <li class="nav-item">
                                        <a
                                            class="nav-link d-flex align-items-center gap-2"href="{{ route('courses.index') }}">
                                ...
                                @if (Route::has('students.index'))
                                    <li class="nav-item">
                                        <a class="nav-link d-flex align-items-center gap-2"
                                            href="{{ route('students.index') }}"><i
                                                class="bi bi-person"></i>{{ __('Student') }}</a>
                                    </li>
                                @endif
                                @if (Route::has('teachers.index'))
                                    <li class="nav-item">
                                        <a class="nav-link d-flex align-items-center gap-2"
                                            ...
                                            <i class="bi bi-person-video3"></i>{{ __('Teacher') }}</a>
                                    </li>
                                @endif
